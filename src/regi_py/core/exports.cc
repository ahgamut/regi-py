...
void bind_enums(pybind11::object &m)
{
    ...
    py::native_enum<LocationStatus>(m, "LocationStatus", "enum.IntEnum")
        .value("NOT_IN_GAME", LocationStatus::NOT_IN_GAME)
        .value("WITH_PLAYER_1", LocationStatus::WITH_PLAYER_1)
        .value("WITH_PLAYER_2", LocationStatus::WITH_PLAYER_2)
        .value("WITH_PLAYER_3", LocationStatus::WITH_PLAYER_3)
        .value("WITH_PLAYER_4", LocationStatus::WITH_PLAYER_4)
        .value("IN_DRAW_PILE", LocationStatus::IN_DRAW_PILE)
        .value("IN_DISCARD_PILE", LocationStatus::IN_DISCARD_PILE)
...
void bind_cards(pybind11::object &m)
{
    py::class_<Card>(m, "Card")
        ...
        .def_property_readonly("is_yield", &Card::isYield)
        .def_property_readonly("is_resign", &Card::isResign)
...
void bind_phaseinfo(pybind11::object &m)
{
    py::class_<PhaseInfo>(m, "PhaseInfo")
        ...
        .def_static("randomize_from",
                    [](const PhaseInfo &other, i32 currentID = -1)
                    {
...
void bind_gamestate(pybind11::object &m)
{
    py::class_<GameState>(m, "GameState")
        ...
        .def_readonly("history", &GameState::history)
        .def_readwrite("record_history", &GameState::recordHistory)
...
void bind_location(pybind11::object &m)
{
    py::class_<LocationInfo, std::shared_ptr<LocationInfo>>(m, "LocationInfo",
        ...
        .def_static("from_current", &LocationInfo::fromCurrentPlayer)
        .def_static("fromCurrentPlayer", &LocationInfo::fromCurrentPlayer)
...
void bind_combotable(pybind11::object &m)
{
    py::class_<ComboTable, std::shared_ptr<ComboTable>>(m, "ComboTable",
        ...
        .def_static("empty", &ComboTable::emptyTable)
        .def_static("make_combo", &ComboTable::createComboFromTableEntry)
