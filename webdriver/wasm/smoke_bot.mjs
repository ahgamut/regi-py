 ...
 * Then run:     node smoke_bot.mjs   (or all suites via `npm run smoke`)
 *
 ...
 * the graph; the JS-vs-Python golden check is check_golden.mjs).
 *
...
/* Mock ort namespace: Tensor just records what it was handed (no onnxruntime here). */
